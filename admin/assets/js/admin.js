...
$(document).ready(function(){$(".next_btn").on('click',function(){$(this).closest('fieldset').next().fadeIn('slow');$(this).closest('fieldset').css({'display':'none'});$('#progressbar .active').removeClass('active').addClass('activated').next().addClass('active');$('#progress-head .active').removeClass('active').next().addClass('active');});$(".prev_btn").on('click',function(){$(this).closest('fieldset').prev().fadeIn('slow');$(this).closest('fieldset').css({'display':'none'});$('#progressbar .active').removeClass('active').prev().removeClass('activated').addClass('active');$('#progress-head .active').removeClass('active').prev().addClass('active');});});$(".addservice-info").on('click','.trash',function(){$(this).closest('.service-cont').remove();return false;});$(".add-extra").on('click',function(){var servicecontent='<div class="row service-cont">'+
'<div class="col-md-4">'+
...
return false;});})();$(document).on("click",".remove-gallery",function(){$(this).parent().parent().hide();});if($(window).width()<=1199){if($('#task_chat').length>0){$(document).on('click','#task_chat',function(){$('.sidebar-overlay').toggleClass('opened');$('#task_window').addClass('opened');return false;});}}
if($(window).width()>767){if($('.theiaStickySidebar').length>0){$('.theiaStickySidebar').theiaStickySidebar({additionalMarginTop:125});}}
if($('.feather-icon').length>0){feather.replace();}})(jQuery);